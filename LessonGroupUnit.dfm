object frmLessonGroup: TfrmLessonGroup
  Left = 223
  Top = 223
  Width = 699
  Height = 454
  BiDiMode = bdRightToLeft
  Caption = #1711#1585#1608#1607' '#1576#1606#1583#1610' '#1705#1604#1575#1587' '#1607#1575
  Color = clBtnFace
  ...
  object SP_LessonGroup: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TLessonGroup;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsLessonGroup: TDataSource
    DataSet = QLessonGroup
    Left = 144
    Top = 24
  end
  object QLessonGroup: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TLessonGroup')
    Left = 180
    Top = 24
  end
