object frmPcPos: TfrmPcPos
  ...
  Caption = #1662#1610' '#1587#1610' '#1662#1608#1586
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'ip'
        Title.Caption = #1570#1610' '#1662#1610
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
      ...
      item
        Expanded = False
        FieldName = 'port'
        Title.Caption = #1662#1608#1585#1578
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'isActive'
        Title.Caption = #1601#1593#1575#1604' '#1576#1608#1583#1606
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'pspTitle'
        Title.Caption = #1587#1585#1608#1610#1587' '#1583#1607#1606#1583#1607
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object chbIsActive: TCheckBox
      ...
      Width = 81
      Height = 17
      Caption = #1601#1593#1575#1604' '#1576#1608#1583#1606' '
      TabOrder = 3
    end
  ...
  object SP_PcPos: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TPcPos;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object DSPcPos: TDataSource
    DataSet = QPcPos
    Left = 144
    Top = 24
  end
  object QPcPos: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'Select TPcPos.id, TPcPos.title, TPcPos.ip, TPcPos.port, TPcPos.i' +
        'sActive,'
      'TPSP.id pspId, TPSP.title pspTitle'
      'From TPcPos inner join TPSP on TPcPos.pspId = TPSP.id'
      ''
      '')
    Left = 180
    Top = 24
