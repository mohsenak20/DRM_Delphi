object frmOrderDiscount: TfrmOrderDiscount
  Left = 483
  Top = 178
  Width = 695
  Height = 482
  ...
  object SP_OrderDiscount: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_OrderDiscount;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsOrderDiscount: TDataSource
    DataSet = QOrderDiscount
    Left = 144
    Top = 24
  end
  object QOrderDiscount: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TOrderDiscount'
