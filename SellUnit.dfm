object frmSell: TfrmSell
  ...
  Caption = #1601#1585#1608#1588' '#1705#1575#1585#1578
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = #1605#1576#1604#1594' '#1608#1575#1581#1583
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
      ...
      item
        ...
        FieldName = 'FishNum'
        Title.Alignment = taCenter
        Title.Caption = #1588#1605#1575#1585#1607' '#1601#1610#1588
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object Label2: TLabel
      ...
      Width = 76
      Height = 29
      Caption = #1705#1583' '#1576#1575#1586#1575#1585#1610#1575#1576':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object Label5: TLabel
      ...
      Width = 62
      Height = 29
      Caption = #1605#1576#1604#1594' '#1608#1575#1581#1583':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
  ...
  object MainMenuUnit: TMainMenu
    ...
    object N1: TMenuItem
      Caption = #1670#1575#1662
      object mnuDayReport: TMenuItem
        Caption = #1576#1607' '#1578#1601#1705#1610#1705' '#1585#1608#1586
        OnClick = mnuDayReportClick
      end
    end
  end
  ...
  object SP_Sell: TADOStoredProc
    Connection = DM.ADOConnection
    DataSource = DSSell
    ProcedureName = 'SP_Sell;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QSell: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select FactorID, Date, TSell.CustomerID, CustomerName,'
      
        'TSell.VisitorID, VisitorName, Number, VahedPrice, FromNum, ToNum' +
        ', FishNum, TCustomer.Address'
      
        'from TSell inner join TCustomer on TCustomer.CustomerID=TSell.Cu' +
        'stomerID'
      'inner join TVisitor on TVisitor.VisitorID=TSell.VisitorID'
      ''
      ''
      '')
    Left = 164
  ...
  object QDayReport: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <>
    SQL.Strings = (
      
        'select Date, TSell.VisitorID, VisitorName, sum(Number) number, s' +
        'um(Number*VahedPrice) price'
      
        'from TSell inner join TVisitor on TVisitor.VisitorID=TSell.Visit' +
        'orID'
      'group by Date, TSell.VisitorID, VisitorName'
      'order by Date')
    Left = 96
    Top = 272
  end
