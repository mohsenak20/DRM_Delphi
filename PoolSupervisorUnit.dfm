object frmPoolSupervisor: TfrmPoolSupervisor
  Left = 566
  Top = 368
  Width = 770
  Height = 504
  BiDiMode = bdRightToLeft
  Caption = #1605#1583#1610#1585#1575#1606' '#1570#1605#1608#1586#1588
  Color = clBtnFace
  ...
  object SP_PoolSupervisor: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_PoolSupervisor;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsPoolSupervisor: TDataSource
    DataSet = QPoolSupervisor
    Left = 144
    Top = 24
  end
  object QPoolSupervisor: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TPoolSupervisor')
    Left = 180
    Top = 24
  end
