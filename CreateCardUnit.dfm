object frmCreateCard: TfrmCreateCard
  Left = 469
  Top = 236
  Width = 971
  Height = 634
  BiDiMode = bdRightToLeft
  Caption = #1575#1610#1580#1575#1583' '#1603#1575#1585#1578
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #1578#1575#1585#1610#1582' '#1575#1606#1602#1590#1575#1569
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -19
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'CardID'
        Title.Caption = #1603#1583' '#1603#1575#1585#1578
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -19
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'BarCode'
        Title.Caption = #1576#1575#1585#1603#1583
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -19
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'Credit'
        Title.Caption = #1605#1610#1586#1575#1606' '#1575#1593#1578#1576#1575#1585
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -19
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'CardTypeName'
        Title.Caption = #1606#1608#1593' '#1603#1575#1585#1578
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -19
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object Label5: TLabel
      ...
      Width = 159
      Height = 29
      Caption = #1606#1575#1605' '#1588#1585#1603#1578' '#1591#1585#1601' '#1602#1585#1575#1585#1583#1575#1583':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object Label1: TLabel
      ...
      Width = 125
      Height = 29
      Caption = #1578#1575#1585#1610#1582' '#1588#1585#1608#1593' '#1575#1587#1578#1601#1575#1583#1607':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object Label7: TLabel
      ...
      Width = 90
      Height = 29
      Caption = #1605#1576#1604#1594' '#1607#1585' '#1580#1604#1587#1607':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object Label9: TLabel
      ...
      Width = 69
      Height = 29
      Caption = #1578#1575#1585#1576#1582' '#1575#1593#1578#1576#1575#1585':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object chbGetMoney: TCheckBox
      Left = 656
      Top = 243
      Width = 81
      Height = 17
      Caption = #1583#1585#1610#1575#1601#1578' '#1608#1580#1607
      TabOrder = 15
    end
  ...
  object Panel1: TPanel
    ...
    object Label15: TLabel
      ...
      Width = 93
      Height = 29
      Caption = #1588#1605#1575#1585#1607' '#1603#1575#1585#1578' '#1575#1586':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
  ...
  object SP_CreateCard: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_CreateCard;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QCard: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    OnCalcFields = QCardCalcFields
    Parameters = <>
    SQL.Strings = (
      
        'select TBargain.BargainID, TBargain.BargainDate, TCompany.Compan' +
        'yID, TCompany.CompanyName, '
      
        'TCard.CardID, TCard.Credit, TCard.CreateDate, TCard.ExpireDate, ' +
        'TCardType.CardTypeID,'
      'TCardType.CardTypeName From TBargain'
    ...
    Left = 212
    Top = 160
    object QCardBargainID: TIntegerField
      FieldName = 'BargainID'
    end
    object QCardBargainDate: TStringField
      FieldName = 'BargainDate'
      FixedChar = True
      Size = 10
    end
    object QCardCompanyID: TSmallintField
      FieldName = 'CompanyID'
    end
    object QCardCompanyName: TWideStringField
      FieldName = 'CompanyName'
      Size = 100
    end
    object QCardCardID: TLargeintField
      FieldName = 'CardID'
    end
    object QCardCredit: TIntegerField
      FieldName = 'Credit'
    end
    object QCardExpireDate: TStringField
      FieldName = 'ExpireDate'
      FixedChar = True
      Size = 10
    end
    object QCardCardTypeID: TSmallintField
      FieldName = 'CardTypeID'
    end
    object QCardCardTypeName: TWideStringField
      FieldName = 'CardTypeName'
      Size = 50
    end
    object QCardMinCardID: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'MinCardID'
      Calculated = True
    end
    object QCardMaxCardID: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'MaxCardID'
      Calculated = True
    end
    object QCardCreateDate: TStringField
      FieldName = 'CreateDate'
      FixedChar = True
      Size = 10
    end
  ...
  object QMinMax: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select Min(CardID) as MinCardID, Max(CardID) as MaxCardID from T' +
        'Card'
