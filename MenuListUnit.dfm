object frmMenuList: TfrmMenuList
  ...
  Caption = #1604#1610#1587#1578' '#1605#1606#1608#1607#1575
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 71
      Height = 27
      Caption = #1593#1606#1608#1575#1606' '#1576#1582#1588':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
      Font.Name = 'Traffic'
  ...
  object QMenu: TADOQuery
    ...
    SQL.Strings = (
      'select TMenu.KalaID, KalaName, VahedName, VahedPrice from TMenu'
      'inner join TKala on TMenu.KalaID = TKala.KalaID'
