object frmTerm: TfrmTerm
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #1578#1593#1583#1575#1583' '#1580#1604#1587#1607' '#1583#1585' '#1583#1608#1585#1607
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'priceForSession'
        Title.Caption = #1588#1607#1585#1610#1607' '#1576#1585#1575#1610' '#1607#1585' '#1580#1604#1587#1607
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object Label3: TLabel
      ...
      Width = 106
      Height = 29
      Caption = #1588#1607#1585#1610#1607' '#1607#1585' '#1580#1604#1587#1607':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object edtPriceForSession: TEdit
      Left = 327
      Top = 252
      Width = 297
      Height = 34
  ...
  object SP_Term: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_Term;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QTerm: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TTerm.*, TRentPool.title rentPoolTitle, TRentPool.startTi' +
        'me, TRentPool.endTime,'
      'TPool.title poolTitle'
      'from TTerm'
  ...
  object QTermSchedule: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TTerm.*, startTime, endTime, saturday, sunday, monday, tu' +
        'esday, wednesday, thursday, friday from TTerm'
      'inner join TRentPool on TTerm.rentPoolId = TRentPool.id'
      'where TTerm.id = :termId')
    Left = 40
    Top = 112
  end
  object SP_TermSchedule: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TTermSchedule;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QRentPool: TADOQuery
    ...
    SQL.Strings = (
      'select * from TRentPool'
      'where id = :id')
    Left = 104
    Top = 112
  end
  object QHoliday: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <
      item
        Name = 'holiday'
