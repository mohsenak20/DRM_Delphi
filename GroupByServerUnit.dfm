object frmGroupByServer: TfrmGroupByServer
  Left = 882
  Top = 228
  Width = 621
  Height = 478
  BiDiMode = bdRightToLeft
  Caption = #1576#1607' '#1578#1601#1705#1610#1705' '#1587#1585#1608#1610#1587' '#1583#1607#1606#1583#1607
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'server'
        Title.Caption = #1705#1583' '#1587#1585#1608#1610#1587' '#1583#1607#1606#1583#1607
        Width = 126
        Visible = True
      end
      item
  ...
  object QQroup: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TFactor.description server, isNull(Sum(TSubFactor.VahedPr' +
        'ice*Number), 0) as sumPrice'
      ...
      'where ReceptionDate = '#39'1401/07/26'#39' and Tfactor.UserId = 285'
      'Group by TFactor.description'
      'order by TFactor.description'
      ''
      '')
    Left = 72
    Top = 64
