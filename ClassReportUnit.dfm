object frmClassReport: TfrmClassReport
  Left = 473
  Top = 369
  Width = 1104
  Height = 623
  BiDiMode = bdRightToLeft
  Caption = #1711#1586#1575#1585#1588' '#1593#1605#1604#1705#1585#1583' '#1601#1585#1575#1711#1610#1585
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      item
        ...
        Title.Caption = #1578#1575#1585#1610#1582' '#1711#1586#1585#1575#1588
      ...
      item
        Expanded = False
        FieldName = 'report'
        Title.Caption = #1711#1586#1575#1585#1588
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object SP_ClassReport: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_ClassReport;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsClassReport: TDataSource
    DataSet = QClassReport
    Left = 136
    Top = 96
  end
  object QClassReport: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <
      item
    ...
    SQL.Strings = (
      'select * from TClassReport'
      'where studentAndClassId = :studentAndClassId')
    Left = 172
    Top = 96
  end
