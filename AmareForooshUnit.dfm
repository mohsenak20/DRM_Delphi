object frmAmareForoosh: TfrmAmareForoosh
  Left = 232
  Top = 259
  Width = 714
  Height = 262
  ...
  object Label24: TLabel
    ...
    Width = 39
    Height = 29
    Caption = #1575#1594#1584#1610#1607':'
    Font.Charset = ARABIC_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
    Font.Name = 'Traffic'
  ...
  object QFactor: TADOQuery
    ...
    SQL.Strings = (
      ...
      'set @EndDate= :EndDate'
      'if @StartDate<'#39'1387/11/01'#39
      '    set @StartDate= '#39'1388/11/01'#39
      '    '
      
        'select TFactor.UserID as UserID, (Case TFactor.UserID when 4 the' +
        'n '#39#1585#1587#1578#1608#1585#1575#1606#39' when 20 then '#39#1575#1594#1584#1610#1607#39' else '#39#1585#1608#1575#1602#39' end) as Shopname,'
      'sum(Number*VahedPrice)*20/100 AmareForoosh from TReception'
      ...
      'inner join TSubFactor on TFactor.FactorID=TSubFactor.FactorID'
        ...
        'where ReceptionDate<= @EndDate and ReceptionDate>= @StartDate an' +
        'd TFactor.UserID in (4, 20, 38)'
      'Group by TFactor.UserID'
      'order by TFactor.UserID'
      '')
    Left = 32
    Top = 136
  end
