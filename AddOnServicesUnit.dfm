object frmAddOnServices: TfrmAddOnServices
  Left = 194
  Top = 123
  Width = 657
  Height = 422
  BiDiMode = bdRightToLeft
  Caption = #1582#1583#1605#1575#1578' '#1608#1610#1688#1607' '#1575#1610#1606#1578#1585#1606#1578#1610
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object btnAccept: TBitBtn
      ...
      Width = 129
      Height = 36
      Caption = #1575#1585#1575#1606#1607' '#1587#1585#1608#1610#1587
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Koodak'
  ...
  object QAddOnServices: TADOQuery
    ...
    SQL.Strings = (
      'Declare @UserID int, @ReceptionDate char(10), @closedID int'
      'set @ReceptionDate = :ReceptionDate'
      'set @UserID = :UserID'
      'set @closedID = :ClosedID'
      'if @UserID = -1'
      'begin'
      
        '  select TOrderDetails.id, TAddOnServices.title, TOrderDetails.a' +
        'mount, TOrderDetails.price,'
      '  TOrderDetails.discount, UserName, addOnService_id'
      
        '  from TOrderDetails inner join tfactors on TOrderDetails.order_' +
        'id = tfactors.id'
      '  inner join TReception on tfactors.id = Treception.order_id'
      
        '  inner join TAddOnServices on TOrderDetails.addOnService_id = T' +
        'AddOnServices.id'
      '  inner join TUser on TAddOnServices.userID = TUser.UserID'
      '  where ClosedID = @closedID and ReceptionDate = @ReceptionDate'
      'end;'
      'else'
      'begin'
      ...
      '  inner join TUser on TAddOnServices.userID = TUser.UserID'
        ...
        '  where ClosedID = @closedID and ReceptionDate = @ReceptionDate ' +
        'and TAddOnServices.userID = @UserID'
      '  and TorderDetails.used = 0'
      'end;')
    Left = 96
    Top = 128
  end
  object QAccept: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <
      item
        Name = 'order_id'
