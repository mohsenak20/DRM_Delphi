object frmAgeCategory: TfrmAgeCategory
  Left = 151
  Top = 259
  Width = 698
  Height = 451
  ...
  object SP_AgeCategory: TADOStoredProc
    ...
    ProcedureName = 'SP_TAgeCategory;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsAgeCategory: TDataSource
    DataSet = QAgeCategory
    Left = 144
    Top = 24
  end
  object QAgeCategory: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TAgeCategory')
    Left = 180
    Top = 24
  end
