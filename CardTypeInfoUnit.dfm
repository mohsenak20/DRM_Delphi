object frmCardTypeInfo: TfrmCardTypeInfo
  Left = 271
  Top = 257
  Width = 367
  Height = 380
  ...
  object QCardTypeInfo: TADOQuery
    ...
    SQL.Strings = (
      ...
      'where CardTypeName Like :CardTypeName')
    Left = 48
    Top = 16
  end
  object dsCardTypeInfo: TDataSource
    DataSet = QCardTypeInfo
    Left = 88
    Top = 16
  end
end
