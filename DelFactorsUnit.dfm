object frmDelFactor: TfrmDelFactor
  Left = 323
  Top = 123
  Width = 829
  Height = 534
  BiDiMode = bdRightToLeft
  Caption = #1605#1588#1575#1607#1583#1607' '#1601#1575#1705#1578#1608#1585#1607#1575#1610' '#1581#1584#1601' '#1588#1583#1607
  Color = clBtnFace
    ...
    object DBGrid2: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          FieldName = 'DelTime'
          Title.Alignment = taCenter
          Title.Caption = #1587#1575#1593#1578' '#1581#1584#1601
          Visible = True
        end
        item
          Expanded = False
  ...
  object QSubFactor: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TDelFactor.FactorID, TDelSubFactor.Code, TDelSubFactor.Pr' +
        'oductID, KalaName, round(Number, 3) as Number,'
      'TDelSubFactor.VahedPrice from TDelFactor'
      
        'inner join TDelSubFactor on TDelFactor.FactorID=TDelSubFActor.Fa' +
        'ctorID'
      'inner join TKala on TDelSubFActor.ProductID=TKala.KalaID'
      'where TDelFactor.FactorID= :FactorID')
    Left = 320
    Top = 425
  end
