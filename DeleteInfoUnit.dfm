object frmDeleteInfo: TfrmDeleteInfo
  Left = 330
  Top = 129
  Width = 970
  Height = 640
  BiDiMode = bdRightToLeft
  Caption = #1662#1584#1610#1585#1588' '#1607#1575#1610' '#1705#1606#1587#1604' '#1588#1583#1607
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'DelTime'
        Title.Caption = #1586#1605#1575#1606' '#1581#1584#1601
        Visible = True
      end
      item
        Expanded = False
  ...
  object QDeleteInfo: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from TDelReception inner join TUser'
      'on TDelReception.UserID=TUser.UserID')
    Left = 48
    Top = 136
  end
  object dsDeleteInfo: TDataSource
    DataSet = QDeleteInfo
    Left = 88
    Top = 136
  end
