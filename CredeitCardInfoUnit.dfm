object frmCreditCardInfo: TfrmCreditCardInfo
  Left = 876
  Top = 243
  Width = 377
  Height = 434
  BiDiMode = bdRightToLeft
  Caption = #1705#1575#1585#1578' '#1575#1593#1578#1576#1575#1585#1610
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 50
      Height = 28
      Caption = #1606#1575#1605' '#1603#1575#1585#1578':'
    end
  ...
  object QCreditCard: TADOQuery
    ...
    SQL.Strings = (
      'declare @Name nvarchar(50), @CardID nvarchar(10)'
      'set @CardID = :CardID'
      'set @Name = :Name'
      ''
      'if @CardID = '#39'-1'#39
      'begin'
        ...
        #9'select CardID, Name+'#39' '#39'+lastName Name, pic, TCReditGroup.Credit' +
        'GroupID, TCReditGroup.CreditGroupName'
      '  from TCreditCard'
      
        '  inner join TCreditGroup on TCreditCard.CreditGroupID = TCRedit' +
        'Group.CreditGroupID'
      #9'where Name + lastName like @Name'
      'end'
      'else'
      'begin'
