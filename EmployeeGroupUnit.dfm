object frmEmployeeGroup: TfrmEmployeeGroup
  Left = 279
  Top = 230
  Width = 698
  Height = 452
  BiDiMode = bdRightToLeft
  Caption = #1711#1585#1608#1607' '#1662#1585#1587#1606#1604#1610
  Color = clBtnFace
  ...
  object SP_EmployeeGroup: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TEmployeeGroup;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsEmployeeGroup: TDataSource
    DataSet = QEmployeeGroup
    Left = 144
    Top = 24
  end
  object QEmployeeGroup: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TEmployeeGroup')
    Left = 180
    Top = 24
  end
