object frmShopsReport: TfrmShopsReport
  Left = 531
  Top = 204
  Width = 460
  Height = 674
  BiDiMode = bdRightToLeft
  Caption = #1711#1586#1575#1585#1588' '#1705#1575#1585#1705#1585#1583' '#1601#1585#1608#1588#1711#1575#1607#1607#1575
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label19: TLabel
      ...
      Width = 73
      Height = 29
      Caption = #1580#1605#1593' '#1601#1585#1608#1588':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
  ...
  object QShops: TADOQuery
    ...
    SQL.Strings = (
      ...
      'set @EndDate = :endDate'
        ...
        'select TFactor.UserID, userName ShopName, FORMAT(sum(cast(number' +
        ' as bigint)*VahedPrice), '#39'#,#'#39') AmareForoosh'
      ...
      'group by TFactor.UserID, userName'
      'order by sum(cast(number as bigint)*VahedPrice) DESC')
    Left = 56
    Top = 88
  end
  ...
  object QSum: TADOQuery
    ...
    SQL.Strings = (
      ...
      'set @EndDate = :endDate'
        ...
        'select FORMAT(sum(cast(number as bigint)*VahedPrice), '#39'#,#'#39') Ama' +
        'reForoosh'
