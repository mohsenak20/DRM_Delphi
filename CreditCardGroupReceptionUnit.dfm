object frmCreditCardGroupReception: TfrmCreditCardGroupReception
  Left = 449
  Top = 104
  Width = 565
  Height = 594
  BiDiMode = bdRightToLeft
  Caption = #1575#1587#1578#1601#1575#1583#1607' '#1588#1583#1607' '#1705#1575#1585#1578#1607#1575#1610' '#1575#1593#1578#1576#1575#1585#1610' '#1576#1607' '#1578#1601#1705#1610#1705' '#1602#1585#1575#1585#1583#1575#1583' '#1608' '#1711#1585#1608#1607
  Color = clBtnFace
  ...
  object QReceptionCredit: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TCReditGroup.CreditGroupID, TCReditGroup.CreditGroupName,' +
        ' sum(NumberOfAdult) count from TReception inner join TCreditCard' +
        ' on TReception.CreditCardID = TCreditCard.CardID'
      
        'inner join TCReditGroup on TCreditCard.CreditGroupID = TCReditGr' +
        'oup.CreditGroupID'
      'where ReceptionDate >= :StartDate and ReceptionDate <= :EndDate'
      
        'group by TCReditGroup.CreditGroupID, TCReditGroup.CreditGroupNam' +
        'e')
    Left = 56
    Top = 216
  end
  object dsReceptionCredit: TDataSource
    DataSet = QReceptionCredit
    Left = 56
    Top = 256
  end
  object QSum: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select sum(NumberOfAdult) count from TReception inner join TCred' +
        'itCard on TReception.CreditCardID = TCreditCard.CardID'
