object frmKalaGroup: TfrmKalaGroup
  Left = 497
  Top = 203
  Width = 697
  Height = 480
  BiDiMode = bdRightToLeft
  Caption = #1711#1585#1608#1607' '#1705#1575#1604#1575
  Color = clBtnFace
  ...
  object SP_KalaGroup: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TKalaGroupMainOperation;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsKalaGroup: TDataSource
    DataSet = QKalaGroup
    Left = 144
    Top = 24
  end
  object QKalaGroup: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TKalaGroup'
      '')
    Left = 180
    Top = 24
  end
