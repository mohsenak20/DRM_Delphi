object frmClosed: TfrmClosed
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'strLend'
        Title.Caption = #1581#1575#1604#1578' '
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -19
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object lblCustomerName: TLabel
      ...
      Width = 52
      Height = 29
      Caption = #1705#1583' '#1705#1605#1583':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object GroupBox2: TGroupBox
      ...
      Width = 201
      Height = 81
      Caption = #1581#1575#1604#1578
      TabOrder = 3
      object rbOf: TRadioButton
        Left = 16
        Top = 32
        Width = 65
        Height = 17
  ...
  object QClosed: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    OnCalcFields = QClosedCalcFields
    Parameters = <>
    SQL.Strings = (
      'select * from TClosed'
      'order by KeyNumber')
    Left = 180
    Top = 24
    object QClosedKeyNumber: TIntegerField
      FieldName = 'KeyNumber'
    end
    object QClosedStatus: TSmallintField
      FieldName = 'Status'
    end
    object QClosedLend: TBooleanField
      FieldName = 'Lend'
    end
    object QClosedstrStatus: TStringField
      FieldKind = fkCalculated
      FieldName = 'strStatus'
      Size = 5
      Calculated = True
    end
    object QClosedstrLend: TStringField
      FieldKind = fkCalculated
      FieldName = 'strLend'
      Size = 4
      Calculated = True
    end
    object QClosedClosedID: TIntegerField
      FieldName = 'ClosedID'
    end
    object QClosedPositionClosed: TSmallintField
      FieldName = 'PositionClosed'
    end
    object QClosedActive: TBooleanField
      FieldName = 'Active'
    end
  end
  ...
  object SP_Closed: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_SetStatusOnTClosed;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
