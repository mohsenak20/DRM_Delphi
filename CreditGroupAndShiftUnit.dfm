object frmCreditGroupAndShift: TfrmCreditGroupAndShift
  Left = 447
  Top = 202
  Width = 703
  Height = 537
  BiDiMode = bdRightToLeft
  Caption = #1711#1585#1608#1607#1607#1575#1610' '#1575#1593#1578#1576#1575#1585#1610' '#1608' '#1588#1610#1601#1578' '#1607#1575
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtSearchGroupTitle: TEdit
      Left = 416
      Top = 14
      Width = 171
      Height = 34
    ...
    object edtSearchShiftTitle: TEdit
      Left = 64
      Top = 14
      Width = 171
      Height = 34
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'shiftTitle'
        Title.Caption = #1588#1576#1601#1578
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
  ...
  object SP_GroupAndShift: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_CreditGroupAndShift;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsGroupAndShit: TDataSource
    DataSet = QGroupAndShift
    Left = 128
    Top = 144
  end
  object QGroupAndShift: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'select TCreditGroupAndShift.id, CreditGroupName, TCreditGroup.Cr' +
        'editGroupID, Tshift.title shiftTitle, shiftId '
      'from TCreditGroupAndShift '
      
        'inner join TCreditGroup on TCreditGroupAndShift.creditGroupId = ' +
        'TCReditGroup.CreditGroupID'
      'inner join TShift on TCreditGroupAndShift.shiftId = Tshift.id')
    Left = 164
    Top = 144
  end
