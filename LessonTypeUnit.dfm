object frmLessonType: TfrmLessonType
  Left = 795
  Top = 236
  Width = 698
  Height = 453
  ...
  object SP_AgeCategory: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TLessonType;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsLessonType: TDataSource
    DataSet = QLessonType
    Left = 144
    Top = 24
  end
  object QLessonType: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TLessonType')
    Left = 180
    Top = 24
  end
