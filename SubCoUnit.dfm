object frmSubCo: TfrmSubCo
  Left = 236
  Top = 305
  Width = 696
  Height = 480
  BiDiMode = bdRightToLeft
  Caption = #1588#1585#1705#1578#1607#1575' '#1608' '#1575#1588#1582#1575#1589#1610' '#1705#1607' '#1705#1575#1585#1578' '#1583#1585#1610#1575#1601#1578' '#1606#1605#1608#1583#1607' '#1575#1606#1583
  Color = clBtnFace
  ...
  object SP_SubBargainCo: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TSubBargainCo;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
