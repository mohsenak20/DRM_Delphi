object frmInstructor: TfrmInstructor
  ...
  Caption = #1605#1585#1576#1610#1575#1606
  Color = clBtnFace
  ...
  object SP_Instructor: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TInstructor;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsInstructor: TDataSource
    DataSet = QInstructor
    Left = 144
    Top = 24
  end
  object QInstructor: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
