object frmTempBargain: TfrmTempBargain
  Left = 196
  Top = 124
  Width = 861
  Height = 537
  BiDiMode = bdRightToLeft
  Caption = #1579#1576#1578' '#1605#1608#1602#1578' '#1602#1585#1575#1585#1583#1575#1583#1607#1575
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Alignment = taCenter
        Title.Caption = #1588#1605#1575#1585#1607' '#1588#1585#1608#1593
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -15
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object chb50Percent: TCheckBox
      Left = 456
      Top = 203
      Width = 161
      Height = 17
      Caption = #1602#1585#1575#1585#1583#1575#1583' 50 '#1583#1585#1589#1583' '#1605#1610' '#1576#1575#1588#1583'.'
      TabOrder = 13
    end
    object chbSpecialForAfternoon: TCheckBox
      Left = 584
      Top = 235
      Width = 161
      Height = 17
      Caption = #1605#1582#1589#1608#1589' '#1588#1610#1601#1578' '#1593#1589#1585
      TabOrder = 14
    end
    object chbSpecialForNight: TCheckBox
      Left = 448
      Top = 235
      Width = 161
      Height = 17
      Caption = #1605#1582#1589#1608#1589' '#1588#1610#1601#1578' '#1588#1576
      TabOrder = 15
    end
  end
  ...
  object SP_TempBargain: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TempBargain;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
      ...
      item
        Name = '@SpecialForAfternoon'
        Attributes = [paNullable]
        DataType = ftBoolean
        Value = Null
      end
      item
        Name = '@SpecialForNight'
        Attributes = [paNullable]
        DataType = ftBoolean
        Value = Null
      end
  ...
  object dsTempBargain: TDataSource
    DataSet = QTempBergain
    Left = 110
    Top = 79
  end
  object QTempBergain: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TTempBargain inner join TCompany'
      'on TTempBargain.CompanyID=TCompany.CompanyID'
      'order by BargainNumber')
    Left = 146
    Top = 79
  end
  ...
  object QDel: TADOQuery
    ...
    SQL.Strings = (
      'delete TTempBargain'
      'where TempBargainID= :TempBargainID')
    Left = 182
    Top = 79
  end
end
