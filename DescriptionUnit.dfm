object frmDescription: TfrmDescription
  ...
  Caption = #1588#1585#1581' '#1607#1575#1610' '#1593#1605#1608#1605#1610
  Color = clBtnFace
  ...
  object SP_Description: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TDescriptionMainOperation;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object DSVahed: TDataSource
    DataSet = QDescription
    Left = 144
    Top = 24
  end
  object QDescription: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
