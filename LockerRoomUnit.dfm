object frmLockerRoom: TfrmLockerRoom
  Left = 516
  Top = 283
  Width = 700
  Height = 479
  BiDiMode = bdRightToLeft
  Caption = #1585#1582#1578#1705#1606' '#1607#1575
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #1605#1580#1605#1608#1593#1607
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object SP_LockerRoom: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TLockerRoom;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QLockerRoom: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TLockerRoom.*, service_centers.title serviceCenterTitle f' +
        'rom TLockerRoom'
      
        'inner join service_centers on TLockerRoom.serviceCenterId = serv' +
        'ice_centers.id')
    Left = 180
    Top = 24
  end
