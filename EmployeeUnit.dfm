object frmEmployee: TfrmEmployee
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'employeeGroupTitle'
        Title.Caption = #1711#1585#1608#1607' '#1662#1585#1587#1606#1604#1610
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object edtEmployeeGroupTitle: TEdit
      Left = 259
      Top = 110
      Width = 226
      Height = 34
    ...
    object btnEmployeeGroup: TBitBtn
      Left = 225
      Top = 111
      Width = 33
      Height = 32
    ...
    object edtEmployeeGroupId: TEdit
      Left = 487
      Top = 110
      Width = 42
      Height = 34
  ...
  object SP_Employee: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TEmployee;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QEmployee: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TEmployee.*, TEmployeeGroup.title employeeGroupTitle from' +
        ' TEmployee '
      
        'inner join TEmployeeGroup on TEmployee.employeeGroupId = TEmploy' +
        'eeGroup.id')
    Left = 180
    Top = 24
  end
