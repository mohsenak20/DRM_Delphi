object frmWorkSection: TfrmWorkSection
  Left = 558
  Top = 145
  Width = 696
  Height = 480
  ...
  object SP_WorkSection: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TWorkSectionMainOperation;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsWorkSection: TDataSource
    DataSet = QWorkSection
    Left = 144
    Top = 24
  end
  object QWorkSection: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * From TWorkSection'
      '')
    Left = 180
    Top = 24
  end
