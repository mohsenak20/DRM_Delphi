object frmHotelReception: TfrmHotelReception
  Left = 176
  Top = 123
  Width = 968
  Height = 612
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        ReadOnly = True
        Title.Caption = #1662#1584#1610#1585#1588' '#1607#1578#1604
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object Label2: TLabel
      ...
      Width = 119
      Height = 29
      Caption = #1606#1575#1605' '#1605#1587#1574#1608#1604' '#1662#1584#1610#1585#1588':'
      Font.Charset = ARABIC_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
      Font.Name = 'Traffic'
    ...
    object edtReceptionistName: TEdit
      Left = 235
      Top = 70
      Width = 287
      Height = 37
  ...
  object SP_Receptionistr: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_HotelReception;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsReceptionist: TDataSource
    DataSet = QReceptionist
    Left = 136
    Top = 192
  end
  object QReceptionist: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    BeforeDelete = QReceptionistBeforeDelete
    Parameters = <
      item
        Name = 'HotelName'
        Size = -1
    ...
    SQL.Strings = (
        ...
        'Select HotelReceptionID, THotel.HotelID, HotelName, Receptionist' +
        'Name, THotelReception.Tel, Comment, THotelReception.Mod1'
      
        'From THotelReception inner join THotel on THotelReception.HotelI' +
        'D = THotel.HotelID'
      'where HotelName Like :HotelName'
      'order by HotelReceptionID')
    Left = 172
    Top = 192
  end
  ...
  object QDelete: TADOQuery
    ...
    SQL.Strings = (
      'delete THotelReception'
      'where HotelReceptionID = :HotelReceptionID')
    Left = 80
    Top = 232
  end
end
