object frmReceptionCreditCardReport: TfrmReceptionCreditCardReport
  Left = 408
  Top = 171
  Width = 1062
  Height = 594
  BiDiMode = bdRightToLeft
  Caption = #1575#1587#1578#1601#1575#1583#1607' '#1588#1583#1607' '#1705#1575#1585#1578#1607#1575#1610' '#1575#1593#1578#1576#1575#1585#1610
  Color = clBtnFace
  ...
  object QReceptionCredit: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select * from TReception inner join TCreditCard on TReception.Cr' +
        'editCardID = TCreditCard.CardID'
      
        'where ReceptionDate >= '#39#39' and ReceptionDate <= '#39#39' and CreditGrou' +
        'pID = 1')
    Left = 56
    Top = 216
  end
