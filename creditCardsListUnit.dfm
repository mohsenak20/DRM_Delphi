object frmCreditCardsList: TfrmCreditCardsList
  Left = 586
  Top = 195
  Width = 1341
  Height = 768
  BiDiMode = bdRightToLeft
  Caption = #1604#1610#1587#1578' '#1705#1575#1585#1578#1607#1575#1610' '#1589#1575#1583#1585' '#1588#1583#1607
  Color = clBtnFace
  ...
  object QCreditCard: TADOQuery
    ...
    SQL.Strings = (
        ...
        'neralCode, NotActive,'
      'gender.title genderTitle, genderId'
