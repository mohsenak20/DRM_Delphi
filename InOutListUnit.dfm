object frmInOutList: TfrmInOutList
  Left = 575
  Top = 236
  Width = 756
  Height = 675
  BiDiMode = bdRightToLeft
  Caption = #1604#1610#1587#1578' '#1608#1585#1608#1583' '#1608' '#1582#1585#1608#1580' '#1662#1585#1587#1606#1604
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'inOutTitle'
        Title.Caption = #1606#1608#1593
        Width = 110
        Visible = True
      end>
  end
  object QinOut: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <>
    SQL.Strings = (
      
        'select TInOut.*, TEmployee.name, TInOutType.title inOutTitle , T' +
        'EmployeeGroup.title employeeGroupTitle'
      'from TInOut'
      'inner join TEmployee on TInOut.employeeId = TEmployee.id'
      'inner join TInOutType on TInOut.inOutTypeId = TInOutType.id'
