object frmGroupKala: TfrmGroupKala
  Left = 267
  Top = 185
  Width = 619
  Height = 480
  BiDiMode = bdRightToLeft
  Caption = #1711#1586#1575#1585#1588' '#1576#1607' '#1578#1601#1705#1610#1705' '#1705#1575#1604#1575
  Color = clBtnFace
  ...
  object QQroup: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <>
    SQL.Strings = (
      
        'select KalaID, KalaName, Round(Sum(Number), 0) as sumNumber, Sum' +
        '(TSubFactor.VahedPrice*Number) as sumPrice'
      ...
      'where FactorType=  2 and TFactor.Active=1 and preFactor=0'
      'Group by KalaID, KalaName'
      'order by sumNumber'
      ''
      '')
    Left = 72
