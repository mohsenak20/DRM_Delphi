object frmCompany: TfrmCompany
  ...
  Caption = #1588#1585#1705#1578' '#1607#1575#1610' '#1591#1585#1601' '#1602#1585#1575#1585#1583#1575#1583
  Color = clBtnFace
  ...
  object SP_Company: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TCompanyMainOperation;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
