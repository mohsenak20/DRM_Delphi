object frmTermAndSupervisor: TfrmTermAndSupervisor
  Left = 544
  Top = 154
  Width = 691
  Height = 573
  BiDiMode = bdRightToLeft
  Caption = #1578#1585#1605' '#1608' '#1605#1583#1610#1585' '#1570#1605#1608#1586#1588
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Align = alClient
    BiDiMode = bdRightToLeft
    DataSource = dsTermAndSupervisor
    Font.Charset = ARABIC_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'Traffic'
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #1606#1575#1605' '#1605#1583#1610#1585
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object GroupBox: TGroupBox
    ...
    object edtSupervisorName: TEdit
      Left = 204
      Top = 80
      Width = 253
      Height = 34
  ...
  object Panel1: TPanel
    ...
    object edtSPoolSupervisorId: TEdit
      Left = 564
      Top = 48
      Width = 42
      Height = 34
    ...
    object edtSPoolSupervisorName: TEdit
      Left = 340
      Top = 48
      Width = 221
      Height = 34
    ...
    object btnSPoolSupervisor: TBitBtn
      Left = 305
      Top = 49
      Width = 35
      Height = 33
      ...
      ParentFont = False
      TabOrder = 6
      OnClick = btnSPoolSupervisorClick
      Glyph.Data = {
        B6040000424DB604000000000000360000002800000012000000100000000100
        20000000000080040000120B0000120B00000000000000000000D8E9EC00D8E9
        EC00D8E9EC00D8E9EC00D8E9EC00D8E9EC00D8E9EC00D8E9EC00D8E9EC00D8E9
  ...
  object SP_TermAndSupervisor: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_TermAndSupervisor;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsTermAndSupervisor: TDataSource
    DataSet = QTermAndSupervisor
    Left = 120
    Top = 152
  end
  object QTermAndSupervisor: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'select TTermAndSupervisor.*, TTerm.title TermTitle, TPoolSupervi' +
        'sor.name supervisorName from TTermAndSupervisor'
      'inner join TTerm on TTermAndSupervisor.termId = TTerm.id'
  ...
  object QDelete: TADOQuery
    ...
    SQL.Strings = (
      'delete TTermAndSupervisor'
      'where id = :id')
    Left = 72
    Top = 192
  end
  object QPoolAndSupervisor: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <
      item
        Name = 'termId'
    ...
    SQL.Strings = (
      'declare @poolId int'
      ''
      'select @poolId = poolId from TTerm inner join TRentPool'
      'on TTerm.rentPoolId = TRentPool.id where TTerm.id = :termId'
      ''
      
        'select poolSupervisorId, name from TPoolAndSupervisor inner join' +
        ' TPoolSupervisor on TPoolAndSupervisor.poolSupervisorId = TPoolS' +
        'upervisor.id'
      'where poolId = @poolId')
    Left = 144
    Top = 216
