object frmSetLockerAndUser: TfrmSetLockerAndUser
  Left = 576
  Top = 177
  Width = 694
  Height = 483
  BiDiMode = bdRightToLeft
  Caption = #1575#1582#1578#1589#1575#1589' '#1705#1605#1583' '#1576#1607' '#1662#1584#1610#1585#1588
  Color = clBtnFace
  ...
  object GroupBox: TGroupBox
    ...
    object GroupBox1: TGroupBox
      ...
      object rbchangingRoom1: TRadioButton
        Left = 296
        Top = 24
        Width = 73
        Height = 17
        Caption = #1585#1582#1578#1705#1606'1'
        TabOrder = 2
        OnClick = rbchangingRoom1Click
      end
      object rbchangingRoom2: TRadioButton
        Left = 192
        Top = 24
        Width = 65
        Height = 17
        ...
        TabOrder = 3
        OnClick = rbchangingRoom2Click
      end
      object rbchangingRoom3: TRadioButton
        Left = 80
        Top = 24
        Width = 65
        Height = 17
  ...
  object SP_SetLockerAndUser: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_SetTLockerAndUser;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object DSSetLOckerAndUSer: TDataSource
    DataSet = QSetLockerAndUser
    Left = 144
    Top = 24
  end
  object QSetLockerAndUser: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'Select TSetLockerAndUser.UserID, StartLocker, EndLocker, TSetLoc' +
        'kerAndUser.Active, UserName'
      
        ' From TSetLockerAndUser inner join TUser on TSetLockerAndUser.Us' +
        'erID = TUser.UserID'
      '')
    Left = 180
    Top = 24
