object frmModCreditReport: TfrmModCreditReport
  Left = 192
  Top = 111
  Width = 872
  Height = 553
  BiDiMode = bdRightToLeft
  Caption = #1576#1575#1602#1610#1605#1575#1606#1583#1607' '#1588#1575#1585#1688
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      item
        ...
        Title.Caption = #1588#1605#1575#1585#1607' '#1662#1584#1610#1585#1588
        Width = 105
        Visible = True
      end
      item
  ...
  object dsModCredit: TDataSource
    DataSet = QModCredit
    Left = 64
    Top = 96
  end
  object QModCredit: TADOQuery
    ...
    SQL.Strings = (
      ...
      'set @ReceptionDate= :ReceptionDate'
        ...
        'select ReceptionID, CustomerName, ClosedID, (((Select Sum(TCredi' +
        't.Credit) from TReception inner join TCredit on TReception.Recep' +
        'tionID=TCRedit.ReceptionID '
      
        'where TReception.ReceptionID= TR.ReceptionID and ExitUserID is n' +
        'ull)-'
      ...
      'inner join TSubFactor on TFactor.FactorID=TSubFactor.FactorID'
        ...
        #9#9'where TReception.ReceptionID=TR.ReceptionID and ExitUserID is ' +
        'null))) as ModCharge'
      'from TReception as TR'
      'where REceptionDate=@ReceptionDate and'
