object frmReceptionCreditCard: TfrmReceptionCreditCard
  Left = 293
  Top = 117
  Width = 786
  Height = 574
  ...
  object DBGrid1: TDBGrid
    ...
    Height = 375
    Align = alClient
    DataSource = dsReceptionCreditCard
  ...
  object QReceptionCreditCard: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select ReceptionDate, CustomerName, CreditCardID, SUM(NumberOfAd' +
        'ult) sumNumber from TReception'
      
        'where ReceptionDate = :Receptiondate and CreditCardID is not nul' +
        'l'
      'group by ReceptionDate, CustomerName, CreditCardID')
    Left = 80
    Top = 232
  end
  object dsReceptionCreditCard: TDataSource
    DataSet = QReceptionCreditCard
    Left = 128
    Top = 232
  end
end
