object frmHotelTicketSummery: TfrmHotelTicketSummery
  Left = 638
  Top = 267
  Width = 1289
  Height = 531
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'sumMenAdult'
        Title.Caption = #1570' '#1576
        Width = 45
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumMenAdultPrice'
        Title.Caption = #1570' '#1576' '#1605#1576#1604#1594
        Width = 102
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumMenChild'
        Title.Caption = #1570' '#1582
        Width = 43
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumMenChildPrice'
        Title.Caption = #1570' '#1582' '#1605#1576#1604#1594
        Width = 104
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumWomenAdult'
      ...
      item
        Expanded = False
        FieldName = 'sumWomenAdultPrice'
        Title.Caption = #1576' '#1576' '#1605#1576#1604#1594
        Width = 100
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumWomenChild'
        Title.Caption = #1576' '#1582
        Width = 44
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumWomenChildPrice'
        Title.Caption = #1576' '#1582' '#1605#1576#1604#1594
        Width = 92
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'sumAdultPrice'
        Title.Caption = #1576' '#1605#1576#1604#1594
        Width = 112
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'sumChildPrice'
        Title.Caption = #1582' '#1605#1576#1604#1594
        Width = 103
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumCustomer'
        Title.Caption = #1705#1604' '#1578#1593#1583#1575#1583#1610
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'sumPrice'
        Title.Caption = #1580#1605#1593' '#1605#1576#1604#1594
        Width = 149
        Visible = True
      end>
  end
  object QHotelReception: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select issueDate, sum(menAdult) sumMenAdult, sum(menAdult*adultP' +
        'rice) sumMenAdultPrice,  '
      
        'sum(menChild) sumMenChild, sum(menChild*childPrice) sumMenChildP' +
        'rice, '
      
        'sum(womenAdult) sumWomenAdult, sum(womenAdult*adultPrice) sumWom' +
        'enAdultPrice, '
      
        'sum(womenChild) sumWomenChild, sum(womenChild*childPrice) sumWom' +
        'enChildPrice,'
      
        'sum(menAdult+womenAdult) sumAdult, sum((menAdult+womenAdult)*adu' +
        'ltPrice) sumAdultPrice,'
      
        'sum(menChild+womenChild) sumChild, sum((menChild+womenChild)*chi' +
        'ldPrice) sumChildPrice, '
      'sum(menAdult+menChild+womenAdult+womenChild) sumCustomer, '
      
        'sum((menAdult+womenAdult)*adultPrice)+sum((menChild+womenChild)*' +
        'childPrice) sumPrice'
      'from HotelTickets'
      
        'where issueDate >= :startDate and issueDate <= endDate and userI' +
        'd = :UserId'
      'group by issueDate')
    Left = 56
    Top = 88
  end
  object dsHotelReception: TDataSource
    DataSet = QHotelReception
    Left = 56
    Top = 120
  end
end
