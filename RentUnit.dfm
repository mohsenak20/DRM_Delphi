object frmRent: TfrmRent
  ...
  Caption = #1592#1585#1601#1610#1578' '#1607#1575#1610' '#1662#1584#1610#1585#1588
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'startTime'
        Title.Caption = #1588#1585#1608#1593' '#1705#1604#1575#1587
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
      ...
      item
        Expanded = False
        FieldName = 'endTime'
        Title.Caption = #1662#1575#1610#1575#1606' '#1705#1604#1575#1587
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -16
        Title.Font.Name = 'Koodak'
  ...
  object SP_RentPool: TADOStoredProc
    Connection = DM.ADOConnection
    ProcedureName = 'SP_RentPool;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object QRent: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Select TRentPool.*, TPool.title PoolTitle, gender.title genderTi' +
        'tle'
      'From TRentPool'
      'inner join TPool on TRentPool.poolId = TPool.id'
      'inner join gender on TRentPool.genderIdAccepted = gender.id')
    Left = 180
    Top = 24
  end
