object frmIssueTicket: TfrmIssueTicket
  Left = 450
  Top = 218
  Width = 981
  Height = 505
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'email'
        Title.Caption = #1662#1587#1578' '#1575#1604#1705#1578#1585#1608#1606#1610#1705#1610
        Width = 140
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'usedate'
        Title.Caption = #1578#1575#1585#1610#1582' '#1585#1586#1585#1608
        Width = 119
        Visible = True
      end
      item
  ...
  object dsVIP: TDataSource
    DataSet = QVIP
    Left = 16
    Top = 104
  end
  object QVIP: TADOQuery
  ...
  object QCheckTime: TADOQuery
    ...
    SQL.Strings = (
      'declare @shift nvarchar(10), @id int'
      'set @id = :TicketType'
      ''
      'select id, webReceptionType, StartTime,'
      
        'dbo.FormatTimeString(cast(Datepart(hh, Getdate()) as char(2))+'#39':' +
        #39'+cast(Datepart(n, Getdate()) as char(2))) nowTime'
      'from TWebReception'
      'where id = @id'
      '')
    Left = 16
  ...
  object QUpdateUsageDateFactors: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <
      item
        Name = 'current_date'
    ...
    SQL.Strings = (
      'update Tfactors set'
      'UseDate = :current_date'
      'where id = :id')
    Left = 440
    Top = 112
  end
  object QCheckReception: TADOQuery
    Connection = DM.ADOConnection
    Parameters = <
      item
        Name = 'Order_id'
