object frmPQC: TfrmPQC
  Left = 575
  Top = 171
  Width = 811
  Height = 646
  BiDiMode = bdRightToLeft
  Caption = #1711#1586#1575#1585#1588#1575#1578' '#1606#1592#1585' '#1587#1606#1580#1610' '#1575#1586' '#1662#1585#1587#1606#1604
  Color = clBtnFace
  ...
  object Qpqc: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      ,[SubjectID]'
      '      ,[ManagerID]'
      '      ,cast([Point] as decimal(4, 2)) Point'
      '      ,Subject'
      '      ,pe.Firstname+'#39' '#39'+ pe.Lastname personel'
      '      ,per.Firstname+'#39' '#39'+ per.Lastname manager'
      '  FROM [wwlhost_pqc].[dbo].[Points] P'
      
        '  inner join [wwlhost_pqc].[dbo].[Subjects] S on p.SubjectID = s' +
        '.id '
      
        '  inner join [wwlhost_pqc].[dbo].[Persons] pe on p.PersonID = pe' +
        '.id'
      
        '  inner join [wwlhost_pqc].[dbo].[Persons] per on p.ManagerID = ' +
        'per.id'
      '  '
      
        '  where PersonID = :PersonID  and Date >= :StartDate and Date <=' +
        ' :EndDate')
    Left = 16
    Top = 96
  end
  object ADOConnection: TADOConnection
    Connected = True
    ConnectionString = 
      'Provider=SQLOLEDB.1;Password=321!;Persist Security Info=True;Use' +
      'r ID=sa;Initial Catalog=wwlhost_pqc;Data Source=sqlserver'
    LoginPrompt = False
    Provider = 'SQLOLEDB.1'
    Left = 64
    Top = 96
  end
  object dsPQC: TDataSource
    DataSet = Qpqc
    Left = 16
    Top = 144
  end
