object frmPayTuitionList: TfrmPayTuitionList
  Left = 315
  Top = 179
  Width = 1072
  Height = 675
  BiDiMode = bdRightToLeft
  Caption = #1604#1610#1587#1578' '#1662#1585#1583#1575#1582#1610' '#1607#1575#1610' '#1588#1607#1585#1610#1607
  Color = clBtnFace
  ...
  object Grid: TDBGrid
    ...
    Align = alClient
    BiDiMode = bdRightToLeft
    DataSource = dsPaymentEnrollment
    Font.Charset = ARABIC_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'Traffic'
  ...
  object dsPaymentEnrollment: TDataSource
    DataSet = QPaymentEnrollment
    Left = 176
    Top = 240
  end
  object QPaymentEnrollment: TADOQuery
    Connection = DM.ADOConnection
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        ' TPaymentEnrollment.id, TPaymentEnrollment.price payment, UserNa' +
        'me, paymentDate, TLesson.Title, '
      
        'TEnrollment.price enrollmentPrice, TCreditCard.name+'#39' '#39'+TCreditC' +
        'ard.lastName name, TCreditCard.Tel'
      'from TPaymentEnrollment'
      
        'inner join TEnrollment on TPaymentEnrollment.enrollmentId = TEnr' +
        'ollment.id'
      
        'inner join TCreditCard on TEnrollment.creditCardId = TCreditCard' +
        '.id'
      'inner join TLesson on TEnrollment.lessonId = TLesson.id'
      'inner join TUser on TPaymentEnrollment.userId = TUser.UserID')
    Left = 212
    Top = 240
  end
